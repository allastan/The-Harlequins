...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "platinumore": {"life_inv_platinumore"};
			case "platinumbar": {"life_inv_platinumbar"};
			case "silverore": {"life_inv_silverore"};
			case "silverbar": {"life_inv_silverbar"};
			case "mushrooms": {"life_inv_mushrooms"};
			case "mushroomextract": {"life_inv_mushroomextract"};
			case "willowbark": {"life_inv_willowbark"};
			case "willowextract": {"life_inv_willowextract"};
			case "wheat": {"life_inv_wheat"};
			case "wheatgrain": {"life_inv_wheatgrain"};
			case "yeast": {"life_inv_yeast"};
			case "sugar": {"life_inv_sugar"};
			case "fungus": {"life_inv_fungus"};
			case "lsd": {"life_inv_lsd"};
			case "tobacco": {"life_inv_tobacco"};
			case "cigarette": {"life_inv_cigarette"};
			case "poppyseed": {"life_inv_poppyseed"};
			case "opium": {"life_inv_opium"};
			case "plastic": {"life_inv_plastic"};
			case "tylenol": {"life_inv_tylenol"};
			case "whisky": {"life_inv_whisky"};
			case "vicodin": {"life_inv_vicodin"};
