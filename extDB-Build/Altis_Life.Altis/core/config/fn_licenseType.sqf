...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "platinumore": {_var = "license_civ_platinum"};
			case "silverore": {_var = "license_civ_silver"};
			case "mushrooms": {_var = "license_civ_mushrooms"};
			case "willowbark": {_var = "license_civ_willowbark"};
			case "wheat": {_var = "license_civ_wheat"};
			case "fungus": {_var = "license_civ_fungus"};
			case "tobacco": {_var = "license_civ_tobacco"};
			case "poppyseed": {_var = "license_civ_poppyseed"};
			case "plastic": {_var = "license_civ_plastic"};
			case "tylenol": {_var = "license_civ_tylenol"};
			case "whisky": {_var = "license_civ_whisky"};
			case "vicodin": {_var = "license_civ_vicodin"};
			case "morphine": {_var = "license_civ_morphine"};
			case "bread": {_var = "license_civ_bread"};
			default {_var = ""};
		};
	};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_platinum": {_var = "platinumore"};
			case "license_civ_silver": {_var = "silverore"};
			case "license_civ_mushrooms": {_var = "mushrooms"};
			case "license_civ_willowbark": {_var = "willowbark"};
			case "license_civ_wheat": {_var = "wheat"};
			case "license_civ_fungus": {_var = "fungus"};
			case "license_civ_tobacco": {_var = "tobacco"};
			case "license_civ_poppyseed": {_var = "poppyseed"};
			case "license_civ_plastic": {_var = "plastic"};
			case "license_civ_tylenol": {_var = "tylenol"};
			case "license_civ_whisky": {_var = "whisky"};
			case "license_civ_vicodin": {_var = "vicodin"};
			case "license_civ_morphine": {_var = "morphine"};
			case "license_civ_bread": {_var = "bread"};
			default {_var = ""};
		};
	};
};
