...
switch (_shop) do
{
	...
	case "heroin": {["Drug Dealer",["cocainep","heroinp","marijuana","lsd","cigarette","opium","whisky","vicodin","morphine"]]};
	...
	case "Legal": {["Legal Goods Trader",["platinumbar","silverbar","mushroomextract","willowextract","wheatgrain","plastic","tylenol","bread","oilp","glass","iron_r","copper_r","diamond","diamondc","salt_r","cement"]]};
};