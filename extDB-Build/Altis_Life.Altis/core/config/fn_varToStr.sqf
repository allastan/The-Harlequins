...
switch (_var) do
{
	...
	case "life_inv_platinumore": {"Platinumore"};
	case "life_inv_platinumbar": {"Platinumbar"};
	case "life_inv_silverore": {"Silverore"};
	case "life_inv_silverbar": {"Silverbar"};
	case "life_inv_mushrooms": {"Mushrooms"};
	case "life_inv_mushroomextract": {"Mushroomextract"};
	case "life_inv_willowbark": {"Willowbark"};
	case "life_inv_willowextract": {"Willowextract"};
	case "life_inv_wheat": {"Wheat"};
	case "life_inv_wheatgrain": {"Wheatgrain"};
	case "life_inv_yeast": {"Yeast"};
	case "life_inv_sugar": {"Sugar"};
	case "life_inv_fungus": {"Fungus"};
	case "life_inv_lsd": {"Lsd"};
	case "life_inv_tobacco": {"Tobacco"};
	case "life_inv_cigarette": {"Cigarette"};
	case "life_inv_poppyseed": {"Poppyseed"};
	case "life_inv_opium": {"Opium"};
	case "life_inv_plastic": {"Plastic"};
	case "life_inv_tylenol": {"Tylenol"};
	case "life_inv_whisky": {"Whisky"};
	case "life_inv_vicodin": {"Vicodin"};
	...
	case "license_civ_mushrooms": {"Mushroom Processing"};
	case "license_civ_willowbark": {"Willowbark Processing"};
	case "license_civ_wheat": {"Wheat Processing"};
	case "license_civ_fungus": {"Fungus Processing"};
	case "license_civ_tobacco": {"Tobacco Processing"};
	case "license_civ_poppyseed": {"Poppyseed Processing"};
	case "license_civ_plastic": {"Plastic Processing"};
	case "license_civ_tylenol": {"Tylenol Processing"};
	case "license_civ_whisky": {"Whisky Processing"};
	case "license_civ_vicodin": {"Vicodin Processing"};
	case "license_civ_morphine": {"Morphine Processing"};
	case "license_civ_bread": {"Bread Processing"};
};
